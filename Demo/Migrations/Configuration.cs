...
{
    internal sealed class Configuration : DbMigrationsConfiguration<Persistance.PlutoContext>
    {
        public Configuration()
        {
            // TODO: Set properties to "false" on production/live environment
            this.AutomaticMigrationsEnabled = true;
            this.AutomaticMigrationDataLossAllowed = true;
        }

        protected override void Seed(Demo.Persistance.PlutoContext context)
        {
            #region Add Tags
